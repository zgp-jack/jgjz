import Taro, { useEffect, useState, useRouter, Config, useDidShow, useReachBottom, useShareAppMessage} from '@tarojs/taro'
...
import {getTodayDate, getRandomShareInfo} from '@/utils/index'
    ...
    <View className='record-work-container'>
      ...
      <View className='record-work-head-date'>
        ...
        <View className='record-work-head-choose-date'>
          ...
          <Image src={`${IMGCDNURL}common/arrow-right.png`} className='record-work-data-image' />
        </View>
      </View>
