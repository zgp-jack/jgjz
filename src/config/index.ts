...
// * 通信录类型 - 班组-筛选-需要展示-已离场
export const ADDRESSBOOKTYPE_GROUP_LEAVE: string = 'group_leave'
// * 通信录类型 - 个人-筛选-需要展示-已删除
export const ADDRESSBOOKTYPE_ALONE_DEL: string = 'alone_del'
