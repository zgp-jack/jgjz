      ...
      <View className='record-work-person-content'>
        {dataList.map((obj, index) => (
          <View className='record-work-person-item' key={index}>
            <View
              className={obj.check ? (obj.status ? 'record-work-person-box choose-box recorded-choose-box' : 'record-work-person-box choose-box') : (obj.status ? 'record-work-person-box recorded-box' : 'record-work-person-box')}>{obj.name}
              {(obj.status && !obj.check) &&
